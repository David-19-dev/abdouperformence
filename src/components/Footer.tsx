        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          <div>
            <div className="flex items-center mb-5">
              ...
              <span className="font-bold text-xl">BBP Performance</span>
            </div>
            <p className="text-gray-400 mb-6">
              Transformer les corps et les vies grâce à un coaching sportif professionnel et des programmes d'entraînement personnalisés.
            </p>
          ...
          <div>
            <h3 className="text-lg font-bold mb-5">Liens Rapides</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/services" className="text-gray-400 hover:text-red-400 transition-colors duration-200" onClick={scrollToTop}>
                  Coaching Personnel
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-lg font-bold mb-5">Contactez-nous</h3>
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  {import.meta.env.VITE_CONTACT_EMAIL || 'contact@bambaperformance.com'}
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} BBP Performance. Tous droits réservés.
            </p>
